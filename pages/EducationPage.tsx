...
export const EducationPage: React.FC<EducationPageProps> = ({ onBack, onStartSimulation }) => {
    ...
    <div className="min-h-screen bg-slate-50 font-sans animate-fadeIn">
      ...
      <nav className="h-20 border-b border-slate-200 bg-white flex items-center justify-between px-6 sticky top-0 z-30">
        ...
        <div className="flex gap-4 items-center">
             ...
             <Button onClick={onStartSimulation} className="text-xs px-4 py-2 shadow-lg shadow-brand-500/20">
               Launch Simulator
             </Button>
        </div>
      </nav>

      <main className="max-w-7xl mx-auto p-6 md:p-12 pb-24">
